...
async function main() {
    ...
    const mint = new web3.PublicKey("6WDaF1Xa38CUumsZ3aPz4M8ZzJRe86L22XPB5hhbEwtq");
    ...
    const tokenData = {
        name: "POLO TOKEN",
        symbol: "POLO",
        uri: "https://ipfs.io/ipfs/QmbBgQAKLK6YzDWeZ9JVWGzfKvyXQ4S82Ln8RefGFFbEze?filename=polo_token.json",
        // we don't need that
